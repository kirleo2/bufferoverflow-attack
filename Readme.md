...
- After made changes, let's run program with OllyDbg again. Now we can see, that addresses on stack are always the same. So we can make a stack snapshot on the start and the end of main function.
